...
urlpatterns = [
    ...
    path("network/carrier-profiles/", views.info_network_carrier_profile, name="info_network_carrier_profile"),
    path("network/broker-profiles/", views.info_network_broker_profile, name="info_network_broker_profile"),
